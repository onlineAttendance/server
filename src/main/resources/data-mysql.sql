...
insert into users (attendance_number, name, birth, password, face_image_uri, team) values (0, '이영찬','02.04.26.','$40801$QGveTEiWKRNSiqXQ15zRbD7954OEmgqh2B0tOaS2vlL9dEeaX3VHfU0XVlPgt1ufZIY1uJiipogEGzTi/LDSIQ==$5PkxdDyxob7rsgJ2IwzOT2xrYbTUCX6kBiSK30DmGdA=','default.png', '복통');
...
성도는 지금을 하나님의 임재와 통치 가운데 살아가며 영원한 하나님의 나라에서의 삶을 소망하며 사는 사람들로서 자녀, 신부, 백성, 종 등의 정체성을 가지고 살아가는 사람들입니다.
그러한 삶을 살아가는 성도는 마땅히 믿음을 가지고 겸손한 마음으로 하나님의 뜻과 계획에 순종하는 삶을 살게 되며 그 안에서 우리 삶의 기준이 하나님이 된다는 것을 알게 됩니다.
청년부 지체들의 삶이 하나님의 나라 가운데 살며 하나님과 동행하는 복을 누리는 삶이 되길 소망합니다.');
insert into question (orders, post_id, content) values (1, 1, '지금 내 삶을 이끌어가는 가장 큰 요소는 무엇인가요?(직업, 관심, 사람, 고민 등)');
insert into question (orders, post_id, content) values (2, 1, '삶에서 하나님의 인도하심과 이끄심을 경험한 적이 있나요?');

insert into post (title, date, content) values ('엎드려 복 받기 - ③ 가난한 마음, 부요한 삶', '2023-02-05','사람은 누구나 부요한 삶을 꿈꿉니다. 돈이 많아 부요하고 관계가 많아 부요하고 삶이 즐거워 부요한 삶을 살아가는 것을 싫어하거나 거부할 사람은 없을 것입니다.\r\n하지만 예수님께서는 우리에게 가난한 마음을 가지라고 하십니다. 우리가 일상에서 우리의 삶을 풍요롭게 채우기 위해 노력하는 것들을 내려놓고 예수님을 먼저 쫒으라 하십니다. \r\n그 이유는 우리가 스스로 우리의 삶을 행복하게 할 수 없고, 우리의 노력과 열심으로 우리 스스로의 구원을 이뤄낼 수 없기 때문입니다. 아무리 노력하고 잘살아간다고 해도, 심지어 교회활동을 아무리 열심히 한다고 해도 예수님이 없는 인생은 생명에 이를 수 없다는 것입니다.\r\n오직 가난한 마음으로 내 힘으로 구원을 얻을 수 없는 죽을 수밖에 없는 자임을 인정하는 자만이 회개하는 마음으로 예수님을 찾고 용서받고 구원받아 하나님 나라에, 영생에 이를 수 있습니다. \r\n이시간 나를 부요하게 하려고 애썼던 모든 것을 해로 여기고 오직 예수님을 내 마음의 중심에 모시는 복된 시간 되길 소망합니다.');
insert into question (orders, post_id, content) values (1, 2, '나는 행복하기 위해, 내 삶을 즐겁게 살기 위해 어떤 노력을 하고 있나요?');
insert into question (orders, post_id, content) values (2, 2, '나는 가난한 마음을 가지고 예수님을 바라고 있나요?');

insert into post (title, date, content) values ('엎드려 복 받기 - ④ 슬퍼하는 사람들은 행복하다.', '2023-02-12','슬픔은 우리의 마음에 일어나는 자연스러운 현상입니다. 사람들마다 슬퍼하는 상황과 기준은 다르지만 슬픔이 적절하게 발생하면 건강한 마음을 가지고 있다고 할 수 있고, 필요할 때에 슬프지 못한다면 심하게는 무언가가 결여되어 있다고 말하기도 합니다.

그렇다면 성도는 어떤 것에 슬퍼해야 할까요?
1. 우리 힘으로는 죄를 깨닫지도, 이기지도 못한다는 것을 슬퍼해야 합니다.
마태복음 8,9장에 등장하는 병자와 같이 우리 스스로의 힘으로는 병과 같이 우리의 생명을 좀먹는 죄의 문제를 해결할 수 없고 때로 나병환자처럼 감각이 없어져 죄와 함께 살아가는 것을 당연하게 여기게도 됩니다.
죄와 함께 살아간다는 것은 단순히 죄로 규정된 행위를 하는 것으로 그치는 것이 아닌 하나님을 하나님으로 인정하고 섬기지 않는다는 것을, 심지어는 내 안에서 하나님을 죽이려는 마음이라고 할 수 있습니다.
성도는 그러한 죄된 마음이 내 안에 있음을 슬퍼해야 합니다.

2. 내 안에 믿음이 없는 것을, 있는 믿음도 약해지는 것을 슬퍼해야 합니다.
성도는 오직 믿음으로 구원을 받습니다. 죄의 문제도, 생명의 문제도 모두 하나님이 은혜로 주시는 믿음으로 해결됩니다. 따라서 죽음 앞에서 생명을 바라는 성도는 무엇보다 믿음을 바라야 합니다. 내 안에 하나님을 죽이려는 죄를 거절하고, 나의 생각과 나의 뜻, 나의 판단을 죽이고, 하나님의 말씀을 믿는 믿음이 없다면 성도는 이를 슬퍼하며 하나님이 주시는 믿음을 구해야 합니다.

3. 내게 예수님을 닮은 모습이 없는 것을 슬퍼해야 합니다.
하나님은 예수 그리스도의 보혈의 은혜로 성도를 새사람이 되게 하셨습니다. 믿는 자들로 하여금 예수님의 형상으로 살 수 있게 하셨고 그것을 기뻐하십니다. 하지만 내가 성도라고 하면서 내 삶에 예수님을 닮은 모습이 발견되지 않는다면 성도는 이를 슬퍼하며 예수님을 닮기를 힘써야 합니다.

애통하는 자는 복이 있나니 그들이 위로를 받을 것이라 말씀하셨습니다.
우리가 우리의 죄됨을, 믿음이 없음을, 예수님을 닮지 않은 나의 모습을 슬퍼하며 하나님을 구할 때, 하나님은 때를 따라 돕는 은혜로 우리를 새롭게 하시며, 결국 우리의 슬픔이 기쁨되게, 행복이 되게 하십니다.
사랑으로 위로하시며 생명으로 인도하시는 하나님을 경험하는 청년부 지체들 되길 소망하며 축복합니다.');
insert into question (orders, post_id, content) values (1, 3, '내가 주로 두려워하거나 슬퍼하는 상황이나 이유는 무엇인가요?');
insert into question (orders, post_id, content) values (2, 3, '삶에서 나를 지속적으로 괴롭히는 죄의 문제가 있나요?');
insert into question (orders, post_id, content) values (3, 3, '지금 나의 믿음의 상태는 어떠한지, 그리고 그것이 삶에서 어떻게 드러나고 있는지를 나눠봅시다.');

insert into post (title, date, content) values ('엎드려 복 받기 - ① 푯대를 향하여', '2023-01-22','사람은 누구나 스스로 무언가를 가치있다고 여기는 것을 간절히 바라고 기다리곤 합니다. 내내 그것만 생각나고 그것을 소유한 나를 상상한다거나 그것을 이미 가진 사람들을 부러워하는 등 모든 신경이 그쪽에 쏠려있게 됩니다. 스스로 돈을 벌고 소비하는 나이가 되면 내가 돈을 가장 많이 쓰는 영역이 내가 가장 가치있다고 여기는 영역이 되는 것을 발견할 수 있습니다.
때로 우리의 기도의 제목들도 내가 원하는 것들로 가득차게 되는 것을 발견할 수 있고 가끔은 기도하는 것보다 원하는 것을 얻기 위한 노력이 더 중요한 것 처럼 여겨질 때도 있습니다.
하지만 잘살펴본다면 우리가 바라고 구하는 것들은 대부분 지금의 삶을 기쁘게 하는 것들이며 죽음 앞에서 힘을 잃는 일시적인 기쁨과 행복을 주는 것들이라는 점을 발견할 수 있습니다. 물론 이와 같은 것들을 하나님은 채워주실 수 있는 분이시지만 우리는 그보다 앞서 구해야 할 하나님의 진짜 좋은 것이 있습니다.

우리가 하나님께 받을 수 있는 가장 좋은 복은 믿음으로 말미암은 구원으로 얻어지는 생명입니다. 하나님께서 우리에게 허락하신 생명은 분명히 마지막 때까지 좋은 것이며 가장 중요한 것입니다.
성경은 우리에게 예수 그리스도로 말미암은 생명은 믿음으로 얻어진다고 증언하고 있습니다. 따라서 우리는 하나님 앞에 겸손한 마음으로 생명을 구하며 또한 믿음을 구해야 하며, 예수 그리스도 안에서 은혜로 그 생명을 누려야 합니다.

우리 안에 예수 그리스도와 연합하여 하나님의 구원, 그리고 생명을 온전하게 누리는 행복이 있길 소망합니다.');
insert into question (orders, post_id, content) values (1, 4, '기도하며 하나님께 복을 구할 때 가장 많이 구하는 것은 무엇인가요?');
insert into question (orders, post_id, content) values (2, 4, '내가 원하는 것을 구하며 기도했는데 이뤄지지 않았을 때 나는 어떻게 반응했나요?');

insert into post (title, date, content) values ('모세의 입 7 - 동역자의 원리', '2023-01-08','1. 하나남의 비전은 무리 마음에 기쁨을 줍니다.
모세가 하나님의 부르심을 받았을 때, 아론도 비슷한 시기에 부르심을 받습니다.
동밀한 부르심을 받은 사람이 만납니다.
그럴 때 어떻게 되나요? 아몬의 마음에 기쁨이 있게 됩니다.
하나님의 뜻이라면, 그중에는 반드시같은 부르심을 받은 사람이 있습니다.
그리고 그 미야기를 듣자마자 아론처럼 마음에 기쁨이 넘치게 됩니다.
우리는 무엇이 하나님의 뜻이고 길인지 헷갈려 합니다.
그런데 오늘 본문이 하나의 석도가 될 수 있습니다.
그것이 하나님의 뜻이라면, 나와 비슷한 시기게 같은 부르심을 받은 사람이 있다는 겁니다.
그리고 그것을 나늘 때, 반드시 기쁨이 생솟는 사람이 생깁니다.

2. 동역에도 질서가 있습니다.
분명 아론과 모세는 비슷한 시기에 부르심을 받았습니다.
그들은 동역자임에 링없습니다. 하지만 그들의 관계는 질서가 있었습니다.
어떤 질서였나요?
하나님께서 모세에게 먼저 말씀하고, 모세가 아론게게 밀하는 것입니다.
분명, 하나님께서 아론에게 직접 말씀하실수도 있습니다.
하지만 하나님께서는 그렇게 일하시지 않으십니다.왜냐하면 동역에도 질서가 있기 때문입니다.');
insert into question (orders, post_id, content) values (1, 5, '리더가 무언가 나누었을 때, 내 마음이 감동되어서 움직이신 적이 있으신가요?');
insert into question (orders, post_id, content) values (2, 5, '내가 개인적으로 받은 하나님의 말씀과 교회의 방향이 다를 때, 나는 어떻게 행동할까요?');

insert into post (title, date, content) values ('낙심이 찾아올 때', '2023-01-01','신앙생활을 하다가 낙심하는 때를 만나게 됩니다. 이렇게 낙심하는 마음이 찾아올 때, 어떻게 대처해야 할까요?

1. 계속적으로 선을 행하는 것입니다.
"우리가 선을 행하되 낙심하지 않지니" 이 부분을 원어로 보면 현재 가정법으로 씌여있습니다.
그래서 이 행함은 계속적이고 반복적인 의미를 가지게 됩니다.
낙심하는 마음이 찾아오면 가장 먼저 어떤 현상이 벌어질까요?
반복적으로 해오던 일을 하고 싶지 않아집니다.
따라서 우리는 열매가 없다 하더라도 계속적으로 나아가야 합니다.

2. 포기하지 않는 마음이 필요합니다.
왜 우리가 포기하고 싶어질까요? 거창한 일 때문이 아닙니다.
오늘의 기분 때문입니다. 하룻밤 자고 나면 사라질 그 기분 말입니다.
따라서 오늘의 기분 때문에 지금까지 쌓아 올린 선한 사업을 포기하지 마시기바랍니다.

3. 하나님의 때를 신뢰하는 것입니다.
실패는 성공의 어머니이고, 실패는 성공을 향한 디딤돌입니다. 세상도 이처럼 성공과 실패를 빗대어 해석합니다.
그렇다면 우리 하나님께서 포기하지 않고 선한 사업을 위해 집을 내는 무리네 민생들에게 어찌 거두게 하지 않으실까요?');
insert into question (orders, post_id, content) values (1, 6, '열심히 살았는데 결과가 좋지 못해서 낙심한 일이 있었나요?');
insert into question (orders, post_id, content) values (2, 6, '기분이 태도가 되지 않게 해야 합니다. 오늘의 나쁜 기분이 내 삶의 태도를 나쁘게 만든 적이 있었나요?');

insert into post (title, date, content) values ('모세의 입 8 - 하나님 같이 되리라', '2023-01-15', '1. 아론은 모세의 권위를 인정해야 한다.
아론은 모세 3살 위 형입니다. 가족 관계를 보면, 첫째가 미리암, 둘째가 아론, 셋째가 모세입니다.
당시 시대관을 반영하면, 아론이 장자로, 가정을 책임져야 했습니다.
그런데 하나님께서는 어떻게 하시나요?
아론보다 모세의 리더십을 더 우위에 두고 있습니다.
심지어 아론에게 모세가 하나님 같이 될 것이다! 말씀하십니다.
분명 아론은 모세의 동역자입니다.
하지만 그럼에도 아론은 영적인 질서를 유지해야 했습니다.
자신의 경계선을 분명하게 설정해야 했던 것입니다. 이것이 바로 하나님께서 부여하신 영적인 질서원리입니다.

2. 우리는 서로 할당받은 영적인 권위를  인정해야 합니다.
성경에서 기름부음 받은 자를 히브리어로 메시야라고 합니다. 이 메시야는 왕, 선지자, 제사장입니다.
이들의 역할은 서로 다릅니다.
왕은 나라를 통치하는 역할, 선지자는 하나님의 말씀을 대언하는 역할, 제사장은 하나님과 사람 사이에 중보자의 역할입니다.
하나님께서 이렇게 영역을 구분하신 이유는 무엇일까요?
서로 서로의 권위를 인정하라는 것입니다. 각 자 기름부음 받은 영역이 있다는 것입니다.
모세의 상황도 마찬가지입니다. 후에 아론이 대제사장으로 임명되면, 제사에 관한 모든 일들은 아론이 주관해야 합니다.');
insert into question (orders, post_id, content) values (1, 7, '나보다 나이가 어린 지체가 리더가 되었을 때, 나는 그 권위를 잘 인정하는 편인가요?');
insert into question (orders, post_id, content) values (2, 7, '권위와 권위주의가 다르다면, 그 차이점은 무엇이 있을까요?');

insert into post (title, date, content) values ('엎드려 복 받기 - ⑤ Good on you', '2023-02-19', '온유하다는 것, 온화하고 온순하다는 것은 인간 정서의 균형을 잃지 않은 상태를 말합니다. 어떤 조건이나 상황 가운데서 분노나 근심, 두려움 같은 정서에도 평안을 유지하며 치우치지 않는 상태를 의미합니다.
그렇다면 예수님을 닮은 온유함은 무엇일까요?

1. 하나님에 대해 온유한 마음입니다.
하나님께 온유하다면 어떠한 상황과 조건에 치우치지 않고 하나님의 말씀에 중심을 두어 순종할 수 있습니다.

2. 자신의 삶에 대한 온유한 마음입니다.
이제 구원받아 하나님 나라에 살게 된 성도는 자신의 삶의 환경과 여건에 휩쓸리지 않고 마음의 평정을 유지하며 마음의 정서를 지킬수 있습니다.

3. 타인에 대해 온유한 마음입니다.
스스로 죄인이었지만 예수 그리스도의 사랑으로 구원받고 용납받았기에 그 사랑을 닮아 내게 불이익을 주는 타인일지라도 온유한 마음과 태도로 사랑하며 용납할 수 있습니다.

호주에서는 잘어울리는 사람에게 “Good on you!”라고 감탄과 칭찬을 한다고 합니다. 성도에게 있어 잘어울리는 옷은 무엇일까요? 성경은 성도에게 온유함의 옷을 입고 예수님을 닮은 온유함으로 살아가길 요청합니다.
어떤 상황에서도 하나님께 감사하고 만족하며 주어진 삶을 순종함으로 살아가는, 예수님을 닮은 모습으로 타인을 사랑하고 용납하는 청년부 지체들 되기를 소망합니다.');
insert into question (orders, post_id, content) values (1, 8, '내가 온유함을 잃게 만드는 것은 주로 무엇인가요?');
insert into question (orders, post_id, content) values (2, 8, '성도가 모든 상황과 모든 사람을 대할 때 온유해야 한다는 것에 대한 자신의 생각을 나눠봅시다.');

insert into post (title, date, content) values ('엎드려 복 받기 - ⑥ Die†', '2023-02-26', '의라는 것은 성경에서 죄와 반대되는 개념으로 사용되며, 하나님의 마음에 합당하게 여김을 받고 하나님께 받아들여지는 상태라고 할 수 있습니다.
성도는 예수 그리스도를 주로 영접하여 그 이름을 믿는 자가 되어 의롭다 칭함을 받은 자들, 즉 칭의 구원을 은혜로 받은 자들 입니다. 이는 다시 말해 예수 그리스도와 함께 우리의 옛 사람은 십자가에 죽고 이제 예수 그리스도와 함께, 그리고 예수 그리스도 안에 살게 되어 하나님으로부터 의롭다함을 받게 되었다는 것입니다.
또한, 이제 성도는 예수 그리스도 안에 살게 되어 의로운 삶을 살아갈 수 있는 능력을 공급받게 된 사람들입니다. 비록 선택한 삶이 때로는 주리고 목마르게 할지라도 그것을 기쁨으로 선택하는 삶이며 그 안에는 하나님의 마음에 합한 삶을 살아가는 것으로 인해 행복이 충만하며, 성도를 죽지 않게 하시며 배부르게 하시는 하나님을 믿고 의지하는 마음이 있게 된다는 것입니다.
...
insert into question (orders, post_id, content) values (3, 10, '오늘 말씀을 통해 사랑에 대하여 결단한 부분이 있다면 나누어 봅시다.');

insert into post (title, date, content) values ('엎드려 복 받기 - ⑧ 흰옷', '2023-03-12', '성도는 예수 그리스도의 보혈의 은혜로 그 죄가 씻기어 정결하게 된 사람들입니다. 예수님께서는 모든 사람의 죄를 위한 대속의 제물로 십자가에 죽으셨으며, 동시에 하나님과의 관계의 회복을 위한 화목제물로서 죽으셨습니다.
구약시대의 제사는 죄의 문제가 발견될 때마다 속죄의 제사가 필요했다면 예수 그리스도께서는 단 한번의 제사로 모든 사람의 죄를 대속하셨습니다.
그러므로 이제 믿음으로 그 죄가 씻김받은 성도는 세상으로부터 구별되어 정결한 자로 부름받아 정결한 삶을 살아가게 됩니다. 성경은 하나님이 성도를 거룩하고 흠이 없게 하시려 십자가의 은혜를 허락하셨다 말씀합니다.
예수님께서는 성도의 정결함에 대하여 그 행위 뿐 아니라 그 중심에 품고 있는 마음을 점검하라고 가르치십니다. 성도는 속사람을 온전하게 하시는 예수님을 의지하여 이전에 갖고 있었던 나의 자아와 나의 마음이 십자가에 죽고, 예수 그리스도의 생명과 마음을 품어 매일의 삶 가운데 하나님을 보며 살아가는 거듭난 인생이 되어야 합니다.
성암교회 청년부 모든 지체들이 예수 그리스도로 인하여 정결하게 되어 구별된 자로서 정결한 마음을 가지고 예수님을 닮아가는 흰옷입은 순결한 백성이 되길 소망합니다.');
insert into question (orders, post_id, content) values (1, 11, '자신이 예수님의 은혜로 정결하게 되었다는 것을 들을 때 어떤 마음인지 자유롭게 나눠봅시다.');
insert into question (orders, post_id, content) values (2, 11, '거룩한 성도로서 세상과 구별되기 위하여 노력하고 있는 것은 무엇인가요?');
insert into question (orders, post_id, content) values (3, 11, '예수님을 묵상하는 사순절 기간이 되기 위하여 무엇을 해야할지 팀별로 정해봅시다.');
